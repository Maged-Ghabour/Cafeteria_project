                ...
                <div class="row">
                    <div class="col-md-6 m-auto form-border">
                        <form action="update.php" method="POST" enctype="multipart/form-data">
                            <h5 class="text-center"> Edit New Product </h5>
                            <div class="form-group mt-2">
                                <label for="name">product name: </label>
                                <input type="text" class="form-control mt-1" name="name" id="name" value="<?php echo $product['name'] ?>">
                            </div>
                            <div class="form-group mt-2">
                                <label for="price">Product Price:</label>
                                <input class="form-control mt-1" name="price" id="price" value="<?php echo $product['price'] ?>">
                            </div>
                            <div class="form-group mt-2">
                            ...
                            <div class="text-center">
                                ...
                                <input class="btn btn-primary mt-3" type="Submit" name="submit" value="Update Product">
                            </div>
                        </form>
                    </div>
